...
import { useHotels, useCreateHotel, useAssignHotel, type Hotel } from "@/hooks/useBookingHotels";
...
export function AssignHotelDialog({ open, onOpenChange, booking }: AssignHotelDialogProps) {
  ...
  // Sort hotels: same city first, then by times_used
  ...
  const isSubmitting = createHotel.isPending || assignHotel.isPending;

  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-lg">
        <DialogHeader>
          <DialogTitle>Tildel hotel</DialogTitle>
          ...
          {!showNewHotel ? (
            <div className="space-y-2">
              ...
              <Select value={selectedHotelId} onValueChange={setSelectedHotelId}>
                <SelectTrigger>
                  <SelectValue placeholder="Vælg et hotel..." />
                </SelectTrigger>
                <SelectContent>
                  {sortedHotels.map((h) => (
            ...
            <div className="space-y-3 border rounded-md p-3 bg-muted/30">
              <div className="flex items-center justify-between">
                ...
                <Button variant="ghost" size="sm" onClick={() => setShowNewHotel(false)}>
                  Annuller
                </Button>
              </div>
        ...
        <DialogFooter>
          ...
          <Button
            ...
            disabled={isSubmitting || (!selectedHotelId && !showNewHotel) || (showNewHotel && (!newName || !newCity))}
          >
            {isSubmitting ? "Gemmer..." : "Tildel hotel"}
          </Button>
        </DialogFooter>
      </DialogContent>
    </Dialog>
