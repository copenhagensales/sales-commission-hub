      ...
      <DialogContent className="max-w-lg max-h-[80vh] overflow-y-auto">
        ...
        <div className="mt-2 space-y-5">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Point gives baseret på din placering i divisionen. Højere divisioner giver flere point — den lavest rangerede i en højere division får altid flere point end den højest rangerede i divisionen under.
            </p>
