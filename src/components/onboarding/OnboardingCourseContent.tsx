...
export function OnboardingCourseContent() {
  ...
  if (daysLoading || progressLoading) {
    return <div className="text-muted-foreground py-8 text-center">Indlæser kursus...</div>;
  }
    ...
    return (
      <Card>
        <CardContent className="py-12 text-center">
          ...
          <p className="text-muted-foreground">Ingen kursusdage oprettet endnu.</p>
        </CardContent>
      </Card>
    );
  }
          ...
          {selectedDayData ? (
            ...
            <Card>
              <CardContent className="py-12 text-center">
                ...
                <p className="text-lg font-medium">Tillykke! Du har gennemført alle kursusdage.</p>
              </CardContent>
            </Card>
          )}
        </div>
