...
export function ChurnTrendChart60DaysFiltered() {
  const { data: chartData, isLoading } = useQuery({
    queryKey: ["churn-trend-chart-60-days-filtered-data"],
    queryFn: async () => {
  ...
  if (isLoading) {
    return (
      <Card>
        <CardHeader>
          <CardTitle>60-dages Churn Udvikling – United & Eesy TM</CardTitle>
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>60-dages Churn Udvikling – United & Eesy TM</CardTitle>
        <CardDescription>
          Andel af nye medarbejdere (United/Eesy TM) der stoppede inden for 60 dage
        </CardDescription>
      </CardHeader>
      <CardContent>
