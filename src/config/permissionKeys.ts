...
export const PERMISSION_KEYS = {
  ...
  tab_employees_deactivation: { label: 'Fane: Deaktivering', section: 'personale', parent: 'menu_employees' },
  ...
  menu_dashboard_eesy_tm_monthly_goal: { label: 'Eesy TM Månedsmål', section: 'dashboards', parent: 'menu_section_dashboards' },
  ...
  menu_reports_weekly_lead_closure: { label: 'Kampagneoversigt Tryg', section: 'reports', parent: 'menu_section_reports' },
  ...
  menu_fm_eesy_deviations: { label: 'Eesy FM afvigelser (Leder)', section: 'fieldmarketing', parent: 'menu_section_fieldmarketing' },
  ...
  tab_fm_checklist: { label: 'Fane: Tjekliste', section: 'fieldmarketing', parent: 'menu_fm_booking' },
