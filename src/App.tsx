...
const CallsData = lazyWithRetry(() => import("./pages/CallsData"));
...
const CandidateDetail = lazyWithRetry(() => import("./pages/recruitment/CandidateDetail"));
        ...
        <BrowserRouter>
          <Suspense fallback={<PageLoader />}>
            <Routes>
              ...
              <Route path="/calls-data" element={<RoleProtectedRoute requireTeamlederOrAbove><CallsData /></RoleProtectedRoute>} />
              ...
              <Route path="/recruitment/candidates/:id" element={<RoleProtectedRoute requireTeamlederOrAbove><CandidateDetail /></RoleProtectedRoute>} />
