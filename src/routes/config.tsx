...
export const routes: RouteConfig[] = [
  ...
  { path: "/vagt-flow", component: VagtFlowIndex, access: "role", requireTeamlederOrAbove: true, positionPermission: "menu_fm_overview" },
  { path: "/vagt-flow/book-week", component: VagtBookWeek, access: "role", requireTeamlederOrAbove: true, positionPermission: "menu_fm_book_week" },
  { path: "/vagt-flow/locations", component: VagtLocations, access: "role", requireTeamlederOrAbove: true, positionPermission: "menu_fm_locations" },
  { path: "/vagt-flow/locations/:id", component: VagtLocationDetail, access: "role", requireTeamlederOrAbove: true, positionPermission: "menu_fm_locations" },
  ...
  { path: "/recruitment", component: RecruitmentDashboard, access: "role", requireTeamlederOrAbove: true, positionPermission: "menu_recruitment_dashboard" },
  { path: "/recruitment/candidates", component: RecruitmentCandidates, access: "role", requireTeamlederOrAbove: true, positionPermission: "menu_candidates" },
  { path: "/recruitment/candidates/:id", component: CandidateDetail, access: "role", requireTeamlederOrAbove: true, positionPermission: "menu_candidates" },
  { path: "/recruitment/messages", component: RecruitmentMessages, access: "role", requireTeamlederOrAbove: true, positionPermission: "menu_messages" },
  { path: "/recruitment/sms-templates", component: SmsTemplates, access: "role", requireTeamlederOrAbove: true, positionPermission: "menu_sms_templates" },
  { path: "/recruitment/email-templates", component: EmailTemplatesPage, access: "role", requireTeamlederOrAbove: true, positionPermission: "menu_email_templates" },
  { path: "/recruitment/winback", component: Winback, access: "role", requireTeamlederOrAbove: true, positionPermission: "menu_winback" },
  { path: "/recruitment/upcoming-interviews", component: UpcomingInterviews, access: "role", requireTeamlederOrAbove: true, positionPermission: "menu_upcoming_interviews" },
  { path: "/recruitment/upcoming-hires", component: UpcomingHires, access: "role", requireTeamlederOrAbove: true, positionPermission: "menu_upcoming_hires" },
