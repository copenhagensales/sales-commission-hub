        ...
        <Dialog open={!!previewContract} onOpenChange={() => setPreviewContract(null)}>
          <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-4">
              ...
              <div
                className="prose prose-invert max-w-none border rounded-lg p-8 bg-card
                  ...
                  prose-h1:tracking-[0.15em] prose-h1:uppercase prose-h1:mb-12 prose-h1:mt-4
                  prose-h1:pb-6 prose-h1:border-b prose-h1:border-foreground/20
                  
                  /* Section Titles (§1, §2 etc.) */
                  ...
                  /* Paragraphs */
                  prose-p:text-muted-foreground prose-p:leading-[1.8] prose-p:my-4
                  prose-p:text-[15px]
