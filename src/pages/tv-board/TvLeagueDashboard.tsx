...
function SceneDivisions({ divisions }: { divisions: DivisionData[] }) {
  ...
  return (
    <div className="h-full flex flex-col">
      <div className="<div className="flex items-center justify-between mb-0.5 2xl:mb-1"> className="flex items-center justify-between mb-0.5 2xl:mb-1">">
        <div>
      ...
      <div className="<div className="mt-0.5 2xl:mt-1 flex flex-wrap gap-x-3 2xl:gap-x-4 gap-y-1 text-[10px] 2xl:text-xs text-slate-500"> gap-x-3 2xl:gap-x-4 gap-y-1 text-[10px] 2xl:text-xs text-slate-500">
