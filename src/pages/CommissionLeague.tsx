...
export default function CommissionLeague() {
  ...
  const handleEnroll = async () => {
    ...
    try {
      ...
      toast.success("Du er nu tilmeldt Provisionsligaen! 🎉");
        ...
        <div className="max-w-4xl mx-auto">
          <Card className="bg-gradient-to-br from-slate-800 to-slate-900 border-slate-700">
            <CardContent className="py-16 text-center">
              ...
              <h1 className="text-2xl font-bold mb-2">Provisionsligaen</h1>
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-2xl md:text-3xl font-bold">Provisionsligaen</h1>
