...
serve(async (req) => {
  ...
  // SECURITY: valider delt webhook-hemmelighed (aktiv når ZAPIER_WEBHOOK_SECRET er konfigureret)
  const secretError = verifyWebhookSecret(req, "ZAPIER_WEBHOOK_SECRET", { corsHeaders });
