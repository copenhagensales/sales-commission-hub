...
serve(async (req) => {
  ...
  // SECURITY: valider delt webhook-hemmelighed (aktiv når ADVERSUS_WEBHOOK_SECRET er konfigureret)
  const secretError = verifyWebhookSecret(req, "ADVERSUS_WEBHOOK_SECRET", { corsHeaders });
