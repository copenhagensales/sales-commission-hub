-- Opdater funktionen til at gemme team-historik i historical_employment før sletning af team_members
...
BEGIN
  ...
  IF OLD.is_active = true AND NEW.is_active = false THEN
    ...
    SELECT 
      ...
      t.name,
      COALESCE(NEW.employment_end_date, CURRENT_DATE) - COALESCE(NEW.employment_start_date, NEW.created_at::date)
