...
REVOKE ALL ON FUNCTION public.get_my_quality_feedback() FROM PUBLIC, anon;
REVOKE ALL ON FUNCTION public.get_quality_feedback_history(uuid) FROM PUBLIC, anon;
