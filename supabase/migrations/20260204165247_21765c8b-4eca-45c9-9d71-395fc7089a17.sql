-- Create enhanced sales aggregates RPC with grouping support
...
COMMENT ON FUNCTION get_sales_aggregates_v2 IS 'Enhanced sales aggregation with grouping support. Use p_group_by to specify grouping: none (totals only), employee, date, or both.';