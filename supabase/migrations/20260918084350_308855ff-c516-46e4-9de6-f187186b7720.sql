-- Kravet er fra 18. sep 2026 EN 1-1 session pr. uge (ikke to).
-- Historik og handlingstyper bevares uaendret; kun kravet aendres.
...
AS $function$
  ...
  missing AS (
    ...
    WHERE en.day_no BETWEEN 1 AND 40
      ...
      AND NOT (en.has_coaching OR en.has_listen)
  ),
  leader_team AS (
